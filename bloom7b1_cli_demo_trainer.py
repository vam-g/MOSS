...
parser.add_argument("--output_dir", default="/mnt/application/leyf/llm_zoo/mmm/output/20230612_ds_trainer_bloom7b1/checkpoint-10500", 
                     type=str)
...
if num_gpus > 1:  
    ...
    # add special token
    special_tokens_dict = {'additional_special_tokens': ['<eoc>','<eoh>','<eom>','<eor>','<eot>','[Human]','[MOSS]','<|Inner Thoughts|>','<|Commands|>','<|Results|>']}
