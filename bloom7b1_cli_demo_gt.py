...
parser.add_argument("--output_dir", default="/mnt/application/leyf/llm_zoo/bloom7b1", 
                     type=str)
...
def main():
    ...
    print("欢迎使用 BLOOM 人工智能助手！输入内容即可进行对话。输入 clear 以清空对话历史，输入 stop 以终止对话。")
    ...
    pd.DataFrame(res).to_csv(os.path.join(args.output_dir,'LLAMA_100Q_A.csv'))
